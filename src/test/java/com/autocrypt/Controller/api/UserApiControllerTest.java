package com.autocrypt.Controller.api;

import com.autocrypt.domain.user.User;
import com.autocrypt.domain.user.Role;
import com.autocrypt.domain.user.UserRepository;
import com.autocrypt.dto.user.UserSaveRequestDto;
...
public class UserApiControllerTest {
    ...
    String url = "http://localhost:" + port + "/api/vi/user";
